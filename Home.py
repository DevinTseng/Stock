...
col2.page_link(page='https://github.com/DevinTseng/Stock/tree/BearBull?tab=readme-ov-file#story-behind-項目背景', label='**Story Behind 開發背景**' , icon='📖')
col2.page_link(page='https://github.com/DevinTseng/Stock/tree/BearBull?tab=readme-ov-file#future-vision-未來願景', label='**Future Vision 未來展望**' , icon='🔭')
col2.page_link(page='https://github.com/DevinTseng/Stock/tree/BearBull?tab=readme-ov-file#how-開發思路', label='**BearBull 指標開發思路**' , icon='📒')
row2.write('---') 
